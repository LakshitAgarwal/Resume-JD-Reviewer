...
3. If a field is missing, skip that section entirely
...
6. For any description fields (job description, project description), break them into bullet points using \\resumeItem{} commands
7. In descriptions, identify and bold important technical terms, technologies, frameworks, metrics, and achievements using \\textbf{} LaTeX command
8. For project links, format the project heading as: {\\textbf{ProjectName} $|$ \\emph{Technologies}}{Date} and then add a separate \\resumeItem{} at the END of each project's description with the links formatted as: \\textbf{Links:} \\href{link}{\\underline{Live Demo}} $|$ \\href{githublink}{\\underline{GitHub}}
9. Combine ALL skills (both technical skills and general skills) into ONE "Technical Skills" section only. Do NOT create separate "Skills" section
10. In the Technical Skills section, categorize them into appropriate subsections like:
...
11. Parse comma-separated skills and group them logically
12. Use proper LaTeX formatting for dates, company names, and project titles
