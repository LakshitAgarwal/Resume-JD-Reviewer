        ...
        <div className="space-y-8">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                    Review your information and generate your professional
                    resume
                </p>
            </div>
                    ...
                    <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-emerald-200/50">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                            <div className="bg-white/80 rounded-lg p-3">
                                ...
                                <span className="text-slate-800">
                                    {getSectionValue(formData.schoolName)}
                                </span>
                            </div>
                            <div className="bg-white/80 rounded-lg p-3">
                                <strong className="text-slate-700">
                                ...
                                <span className="text-slate-800">
                                    {getSectionValue(formData.schoolLocation)}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                <div className="bg-white/80 rounded-lg p-3">
                                    ...
                                    <span className="text-slate-800">
                                        {getSectionValue(formData.percentage10)}
                                        %
                                    </span>
                                </div>
                                <div className="bg-white/80 rounded-lg p-3">
                                    ...
                                    <span className="text-slate-800">
                                        {formatDate(formData.schoolStartDate10)}{" "}
                                        - {formatDate(formData.schoolEndDate10)}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                <div className="bg-white/80 rounded-lg p-3">
                                    ...
                                    <span className="text-slate-800">
                                        {getSectionValue(formData.percentage12)}
                                        %
                                    </span>
                                </div>
                                <div className="bg-white/80 rounded-lg p-3">
                                    ...
                                    <span className="text-slate-800">
                                        {formatDate(formData.schoolStartDate12)}{" "}
                                        - {formatDate(formData.schoolEndDate12)}
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-amber-200/50">
                        <h4 className="font-bold text-slate-800 mb-3 flex items-center gap-2">
                            ...
                            {formData.extraCurricular.length} entries)
                        </h4>
                        <ul className="text-sm text-slate-800 space-y-2">
            ...
            {latexCode && (
                <div className="bg-gradient-to-br from-slate-50 to-gray-50 rounded-3xl p-8 border border-slate-200/50 shadow-xl">
                    ...
                    <p className="text-sm text-slate-600 mt-4 flex items-center gap-2 justify-center">
                        ...
                        Copy this LaTeX code and paste it into an online LaTeX
                        compiler like Overleaf to generate your PDF resume.
                    </p>
                </div>
            )}
        </div>
